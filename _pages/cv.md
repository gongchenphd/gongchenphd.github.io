...
Heidelberg University Medical Faculty, Germany  
2023–2026  

**Doctoral Training in Biomedical Sciences (Medicine)**  
KU Leuven, Belgium  
2022–2023  
...
Research focus:
- Tumor cell plasticity and phenotypic reprogramming in pancreatic cancer
- Molecular mechanisms underlying cancer progression
- MAPK–ERK signaling pathway
- Functional validation using CRISPR/Cas9, RNA sequencing and molecular biology approaches
...
Research training in biomedical sciences and translational medicine.
...
3. Chen G, et al.  
Single-cell transcriptomic analysis identifies an OLFM4-associated gastric cancer cell state with altered metabolic characteristics.  
*Biomolecules*, 2026.
...
- Member of academic societies and scientific communities
- Research collaboration in translational oncology
